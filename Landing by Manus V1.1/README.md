...
Some visual assets are referenced through managed Manus storage URLs. Replace those URLs with your own hosted assets if deploying this folder outside Manus.
