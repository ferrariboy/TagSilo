/**
 * TagSilo Pro V5 - Vanguard Interactive Engine
 * Powers the Live Extension Simulator, Dynamic Tag Toggling,
 * Real-time Google Sheet Row Inserter, Dynamic ROI Calculator,
 * Pricing Frequency Switcher, Accessible FAQ Accordions, and Floating Back-to-Top Button.
 */
...
/* --------------------------------------------------------------------------
   1. Mobile Navigation Menu with Accessible ARIA Sync
   -------------------------------------------------------------------------- */
...
/* --------------------------------------------------------------------------
   2. Live Extension Simulator & Real-time Google Sheet Inserter (ARIA Live)
   -------------------------------------------------------------------------- */
function initExtensionSimulator() {
  ...
  // Update tag active styling, ARIA & counter
  ...
  if (syncBtn) {
    syncBtn.addEventListener('click', (e) => {
      ...
      setTimeout(() => {
        ...
        // Insert animated new row at top of spreadsheet
        if (tableBody) {
...
/* --------------------------------------------------------------------------
   4. Pricing Frequency Switcher with ARIA state
   -------------------------------------------------------------------------- */
function initPricingToggle() {
  ...
  monthlyBtn.addEventListener('click', () => {
    ...
    monthlyBtn.className = 'px-5 py-2 rounded-full text-xs font-bold text-brand-oled bg-brand-lime transition-all focus-visible:ring-2 focus-visible:ring-brand-lime';
    annualBtn.className = 'px-5 py-2 rounded-full text-xs font-bold text-slate-400 hover:text-white transition-all flex items-center gap-1.5 focus-visible:ring-2 focus-visible:ring-brand-lime';
  ...
  annualBtn.addEventListener('click', () => {
    ...
    annualBtn.className = 'px-5 py-2 rounded-full text-xs font-bold text-brand-oled bg-brand-lime transition-all flex items-center gap-1.5 focus-visible:ring-2 focus-visible:ring-brand-lime';
    monthlyBtn.className = 'px-5 py-2 rounded-full text-xs font-bold text-slate-400 hover:text-white transition-all focus-visible:ring-2 focus-visible:ring-brand-lime';
...
/* --------------------------------------------------------------------------
   5. Accessible FAQ Accordions with Smooth ARIA Sync
   -------------------------------------------------------------------------- */
function initFaqAccordion() {
  ...
  headings.forEach(btn => {
    btn.addEventListener('click', (e) => {
      ...
      document.querySelectorAll('#accordion-flush h2 button').forEach(b => b.setAttribute('aria-expanded', 'false'));
