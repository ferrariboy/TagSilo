 ...
 * Warm paper surfaces, forest ink, and Transfer Coral visualize each saved-record handoff.
 */
...
const markUrl = "/manus-storage/tagsilo-icon-48_db0acc90.jpg";
const heroUrl = "/manus-storage/tagsilo-hero-workflow_350b7c3a.png";
const flowUrl = "/manus-storage/tagsilo-flow-diagram_2dab2c12.png";
const contextUrl = "/manus-storage/tagsilo-context-cards_6c7b410e.png";
const textureUrl = "/manus-storage/tagsilo-proof-texture_b43a725c.png";
...
function LedgerMark({ className = "" }: { className?: string }) {
  return <img className={`object-contain ${className}`} src={markUrl} alt="TagSilo mark" />;
}

function InstallButton({ compact = false }: { compact?: boolean }) {
  return (
    <a
      className={`group inline-flex items-center justify-center gap-2 bg-[#e85d43] font-semibold text-white shadow-[0_8px_0_#a93c2b] transition duration-200 hover:-translate-y-0.5 hover:bg-[#d94e35] hover:shadow-[0_11px_0_#a93c2b] active:translate-y-1 active:shadow-[0_3px_0_#a93c2b] ${compact ? "rounded-full px-5 py-3 text-sm" : "rounded-full px-6 py-4 text-base"}`}
      href={chromeWebStore}
      target="_blank"
      rel="noreferrer"
    >
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className="mb-5 flex items-center gap-3 text-[11px] font-bold uppercase tracking-[0.18em] text-[#55746c]">
      <span className="h-px w-7 bg-[#55746c]" />
      {children}
    </div>
  );
}
...
export default function Home() {
  return (
    <div className="min-h-screen overflow-hidden bg-[#f7f5ef] text-[#17352d]">
      <a className="skip-link" href="#main">Skip to content</a>

      <header className="relative z-20 border-b border-[#17352d]/10 bg-[#f7f5ef]/95 backdrop-blur">
        <div className="mx-auto flex max-w-[1440px] items-center justify-between px-5 py-4 lg:px-10">
          <a className="flex items-center gap-2.5" href="#top" aria-label="TagSilo home">
            <LedgerMark className="h-9 w-9" />
            <span className="font-[Fraunces] text-[1.6rem] font-semibold tracking-[-0.07em] text-[#17352d]">TagSilo</span>
          </a>

          <nav className="hidden items-center gap-7 text-sm font-semibold text-[#49655d] md:flex" aria-label="Main navigation">
            <a className="hover:text-[#e85d43]" href="#how-it-works">How it works</a>
            <a className="hover:text-[#e85d43]" href="#who-its-for">Who it&apos;s for</a>
            <a className="hover:text-[#e85d43]" href="#pricing">Pricing</a>
            <a className="hover:text-[#e85d43]" href="#faq">FAQ</a>
          </nav>

          <div className="hidden md:block"><InstallButton compact /></div>
          <button className="rounded-full border border-[#17352d]/15 p-2 text-[#17352d] md:hidden" aria-label="Open navigation menu">
      ...
      <main id="main">
        <section id="top" className="relative overflow-hidden border-b border-[#17352d]/10">
          <div className="hero-grid absolute inset-0 opacity-[0.45]" />
          <div className="absolute -left-40 top-8 h-80 w-80 rounded-full bg-[#c4ead3]/60 blur-3xl" />
          <div className="absolute right-[18%] top-[-110px] h-72 w-72 rounded-full bg-[#ffd8d0]/50 blur-3xl" />
          ...
          <div className="relative mx-auto grid min-h-[690px] max-w-[1440px] items-center gap-10 px-5 py-16 lg:grid-cols-[0.9fr_1.1fr] lg:px-10 lg:py-20">
            <div className="max-w-2xl">
              ...
              <h1 className="max-w-[770px] font-[Fraunces] text-5xl font-semibold leading-[0.95] tracking-[-0.06em] text-[#17352d] sm:text-6xl lg:text-7xl xl:text-[5.6rem]">
                Save and organize LinkedIn leads in Google Sheets—<em className="font-normal text-[#e85d43]">without leaving LinkedIn.</em>
              </h1>
              <p className="mt-7 max-w-xl text-lg leading-8 text-[#49655d] sm:text-xl">
              ...
              <div className="mt-9 flex flex-wrap items-center gap-x-6 gap-y-4">
                <InstallButton />
                <a href="#how-it-works" className="group inline-flex items-center gap-2 text-sm font-bold text-[#17352d]">
                  See how it works <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
                </a>
              </div>
              <div className="mt-8 flex flex-wrap gap-x-5 gap-y-2 text-sm font-medium text-[#55746c]">
                <span className="flex items-center gap-2"><CircleCheck className="h-4 w-4 text-[#e85d43]" /> Free plan available</span>
                <span className="flex items-center gap-2"><CircleCheck className="h-4 w-4 text-[#e85d43]" /> No credit card required</span>
              </div>
            </div>

            <div className="relative mx-auto w-full max-w-[710px] lg:mr-0">
              <div className="absolute -left-6 -top-7 z-10 hidden items-center gap-2 rounded-full border border-[#17352d]/10 bg-[#f7f5ef] px-4 py-2 text-xs font-bold uppercase tracking-[0.16em] text-[#55746c] shadow-sm sm:flex">
                <span className="h-2 w-2 rounded-full bg-[#e85d43]" /> A lead worth keeping
              </div>
              <div className="relative rounded-[2rem] border border-[#17352d]/15 bg-[#f7f5ef] p-2 shadow-[0_20px_60px_rgba(20,59,48,0.14)]">
              ...
              <div className="absolute -bottom-8 -left-4 hidden max-w-[245px] rounded-2xl border border-[#17352d]/10 bg-[#17352d] p-4 text-[#f7f5ef] shadow-xl sm:block">
                <p className="text-[10px] font-bold uppercase tracking-[0.16em] text-[#aee9be]">Transfer complete</p>
                <p className="mt-2 font-[Fraunces] text-xl leading-5">The profile becomes a usable record.</p>
              </div>
              <div className="absolute -right-5 top-[45%] hidden rounded-xl border border-[#17352d]/10 bg-[#f7f5ef] px-3 py-2 shadow-lg lg:block">
                <div className="flex gap-1.5">
                  <span className="tag-cut bg-[#e85d43] px-2 py-1 text-[10px] font-bold text-white">High intent</span>
                  <span className="tag-cut bg-[#c4ead3] px-2 py-1 text-[10px] font-bold text-[#17352d]">Q3 outbound</span>
                </div>
              </div>
            </div>
          </div>
                ...
                {workflowSteps.map((step, index) => {
                  ...
                  return (
                    <article key={step.number} className="group relative rounded-2xl border border-white/10 bg-[#17352d]/90 p-7 backdrop-blur-sm">
                      {index !== workflowSteps.length - 1 && <ArrowRight className="absolute -right-5 top-1/2 z-10 hidden h-9 w-9 -translate-y-1/2 rounded-full border border-white/20 bg-[#e85d43] p-2 text-white lg:block" />}
                      <div className="flex items-center justify-between">
                        <span className="font-mono text-xs font-bold tracking-widest text-[#aee9be]">{step.number}</span>
                        <Icon className="h-5 w-5 text-[#e85d43]" />
                      </div>
        ...
        <section className="border-b border-[#17352d]/10 bg-[#f7f5ef] py-24 lg:py-32">
          <div className="mx-auto grid max-w-[1440px] gap-14 px-5 lg:grid-cols-[0.8fr_1.2fr] lg:px-10">
            <div className="max-w-xl">
              ...
              <p className="mt-8 border-l-2 border-[#e85d43] pl-4 font-[Fraunces] text-xl leading-7 text-[#17352d]">TagSilo keeps lead organization inside the moment you are already working in.</p>
            </div>
            <div className="grid gap-5 sm:grid-cols-3 lg:mt-20">
              {[
                ...
                <article key={number} className="flex min-h-[290px] flex-col rounded-2xl border border-[#17352d]/12 bg-white p-6 shadow-[0_12px_25px_rgba(20,59,48,0.04)]">
                  <span className="font-mono text-xs font-bold tracking-widest text-[#e85d43]">{number}</span>
        ...
        <section className="relative overflow-hidden bg-[#edf3eb] py-24 lg:py-32">
          ...
          <div className="relative mx-auto max-w-[1440px] px-5 lg:px-10">
            <div className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
              ...
              <div className="relative mx-auto max-w-[540px] rotate-[-2deg] rounded-[2rem] border border-[#17352d]/10 bg-[#f7f5ef] p-3 shadow-[0_24px_45px_rgba(20,59,48,0.12)]">
                <img className="aspect-[4/3] w-full rounded-[1.5rem] object-cover" src={contextUrl} alt="Illustrated collection of lead context cards and tags" />
              </div>
            </div>
                ...
                return (
                  <article key={capability.eyebrow} className="group rounded-2xl border border-[#17352d]/10 bg-[#f7f5ef] p-6 transition duration-200 hover:-translate-y-1 hover:shadow-[0_14px_24px_rgba(20,59,48,0.09)]">
                    <div className="flex items-center justify-between text-xs font-bold uppercase tracking-[0.14em] text-[#55746c]">
                      {capability.eyebrow}<Icon className="h-5 w-5 text-[#e85d43]" />
                    </div>
        ...
        <section id="who-its-for" className="border-y border-[#17352d]/10 bg-[#f7f5ef] py-24 lg:py-32">
          <div className="mx-auto max-w-[1440px] px-5 lg:px-10">
            <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr]">
              ...
              <p className="max-w-2xl self-end text-lg leading-8 text-[#49655d]">TagSilo is flexible enough for different prospecting motions, without asking you to adopt a heavy new system.</p>
            </div>
            <div className="mt-14 grid overflow-hidden rounded-[2rem] border border-[#17352d]/10 bg-[#17352d] md:grid-cols-2">
              {audiences.map((audience, index) => (
                <article key={audience.role} className={`group relative min-h-[220px] p-8 text-[#f7f5ef] ${index % 2 === 0 ? "bg-[#17352d]" : "bg-[#22483d]"}`}>
                  <span className="font-mono text-xs font-bold tracking-widest text-[#aee9be]">0{index + 1}</span>
                  ...
                  <ArrowUpRight className="absolute bottom-7 right-7 h-5 w-5 text-[#e85d43] transition-transform duration-200 group-hover:-translate-y-1 group-hover:translate-x-1" />
                </article>
              ))}
            </div>
          </div>
        ...
        <section className="bg-[#f7f5ef] py-24 lg:py-32">
          <div className="mx-auto grid max-w-[1440px] gap-14 px-5 lg:grid-cols-[0.85fr_1.15fr] lg:px-10">
            <div>
              ...
              <div className="mt-8 flex items-start gap-3 rounded-2xl bg-[#fff0ec] p-5 text-sm leading-6 text-[#65443a]"><ShieldCheck className="mt-0.5 h-5 w-5 shrink-0 text-[#e85d43]" /> You choose the profile, the group, the note, and the moment a record is saved.</div>
            </div>
            <div className="overflow-hidden rounded-[2rem] border border-[#17352d]/10 bg-white">
              ...
              {[
                ...
                <div key={before} className="grid grid-cols-[1fr_auto_1fr] items-center gap-4 border-b border-[#17352d]/10 px-6 py-5 last:border-0">
                  ...
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#e85d43] text-white"><ArrowRight className="h-4 w-4" /></div>
          ...
          <div className="mx-auto max-w-[1120px] px-5">
            ...
            <div className="mt-14 grid gap-5 md:grid-cols-2">
              <article className="rounded-[2rem] border border-white/15 bg-[#22483d] p-8 sm:p-10">
                <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#aee9be]">Free</p>
              ...
              <article className="relative rounded-[2rem] border-2 border-[#e85d43] bg-[#f7f5ef] p-8 text-[#17352d] shadow-[0_18px_0_#e85d43] sm:p-10">
                <span className="absolute right-7 top-7 rounded-full bg-[#e85d43] px-3 py-1 text-[10px] font-bold uppercase tracking-[0.14em] text-white">For active prospecting</span>
                <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#e85d43]">TagSilo Pro</p>
                ...
                <ul className="mt-10 space-y-4 text-sm text-[#17352d]">
                  {["Unlimited profile saves", "Unlimited pipeline groups", "Unlimited tags per lead", "A system that matches your process"].map((feature) => <li className="flex gap-3" key={feature}><Check className="mt-0.5 h-4 w-4 shrink-0 text-[#e85d43]" />{feature}</li>)}
                </ul>
                <a href="#top" className="mt-10 block rounded-full bg-[#e85d43] px-5 py-3 text-center text-sm font-bold text-white shadow-[0_5px_0_#a93c2b] transition hover:bg-[#d94e35]">Upgrade to Pro</a>
              </article>
            </div>
        ...
        <section id="faq" className="bg-[#f7f5ef] py-24 lg:py-32">
            ...
            <Accordion type="single" collapsible className="border-t border-[#17352d]/15">
              {faqs.map((faq, index) => (
                <AccordionItem value={`faq-${index}`} key={faq.question} className="border-[#17352d]/15 py-2">
                  <AccordionTrigger className="py-5 text-left font-[Fraunces] text-xl font-semibold tracking-[-0.025em] hover:no-underline">{faq.question}<ChevronDown className="h-4 w-4 shrink-0 text-[#e85d43]" /></AccordionTrigger>
        ...
        <section className="relative overflow-hidden bg-[#e85d43] py-24 text-white lg:py-32">
          ...
          <div className="relative mx-auto max-w-4xl px-5 text-center">
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#ffd9d0]">Your next lead does not need another tab</p>
            ...
            <p className="mx-auto mt-7 max-w-2xl text-lg leading-8 text-[#fff0ec]">Add TagSilo to Chrome and turn the profiles you find on LinkedIn into an organized Google Sheet you can actually use.</p>
            <div className="mt-9"><a className="inline-flex items-center gap-2 rounded-full bg-[#17352d] px-6 py-4 font-bold text-white shadow-[0_8px_0_#0b211a] transition hover:-translate-y-0.5 hover:shadow-[0_11px_0_#0b211a] active:translate-y-1 active:shadow-[0_3px_0_#0b211a]" href={chromeWebStore} target="_blank" rel="noreferrer">Add TagSilo to Chrome — Free <ArrowUpRight className="h-4 w-4" /></a></div>
            <p className="mt-6 text-sm font-medium text-[#fff0ec]">Start with up to 3 saved profiles per day. No credit card required.</p>
          </div>
        </section>
      </main>
      ...
      <footer className="bg-[#17352d] py-10 text-[#c8d9d3]">
        <div className="mx-auto flex max-w-[1440px] flex-col justify-between gap-8 px-5 sm:flex-row sm:items-end lg:px-10">
          <div><a className="flex items-center gap-2.5 text-[#f7f5ef]" href="#top"><LedgerMark className="h-8 w-8" /><span className="font-[Fraunces] text-2xl font-semibold tracking-[-0.06em]">TagSilo</span></a><p className="mt-3 max-w-xs text-sm leading-6">Organize LinkedIn leads in Google Sheets.</p></div>
          <div className="flex flex-wrap gap-x-6 gap-y-3 text-sm font-semibold"><a className="hover:text-[#aee9be]" href="#faq">FAQ</a><a className="hover:text-[#aee9be]" href="mailto:support@tagsilo.com">Support</a><a className="hover:text-[#aee9be]" href={chromeWebStore} target="_blank" rel="noreferrer">Chrome Web Store</a></div>
        </div>
